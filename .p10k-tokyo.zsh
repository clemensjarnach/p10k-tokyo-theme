...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=98 # customize color here
  # Default current directory foreground color.
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=117 # customize color here
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND=79 # customize color here
